...
void Vtb_gpu_top___024root___eval_triggers__act(Vtb_gpu_top___024root* vlSelf) {
    ...
    // Body
    vlSelf->__VactTriggered.set(0U, ((IData)(vlSelf->tb_gpu_top__DOT__clk) 
                                     & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_gpu_top__DOT__clk__0))));
    vlSelf->__VactTriggered.set(1U, (((IData)(vlSelf->tb_gpu_top__DOT__clk) 
                                      & (~ (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_gpu_top__DOT__clk__0))) 
                                     | ((~ (IData)(vlSelf->tb_gpu_top__DOT__rst_n)) 
                                        & (IData)(vlSelf->__Vtrigprevexpr___TOP__tb_gpu_top__DOT__rst_n__0))));
